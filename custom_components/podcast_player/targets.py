...
def output_target_status(entity_id: str, state: Any | None, platform: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "capabilities": {
            ...
            "pause": "supported" if can_pause and live_state else ("best_effort" if is_dlna and live_state else "none"),
            "stop": "supported" if can_stop and live_state else ("best_effort" if live_state else "none"),
            "speed": False,
            "artwork": "metadata",
